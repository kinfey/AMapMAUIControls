...
namespace MAMapKit
{
	...
	*/
	...
	interface MAAnnotation
	{
		...
		//void set_Coordinate(CLLocationCoordinate2D newCoordinate);
	}
	...
	*/
	...
	interface MAMapView
	{
		...
		void AddAnimationWith(CoreAnimation.CAKeyFrameAnimation mapCenterAnimation, CAKeyFrameAnimation zoomAnimation, CAKeyFrameAnimation rotateAnimation, CAKeyFrameAnimation cameraDegreeAnimation);
	...
	*/
	...
	interface MATraceManager
	{
		...
		NSOperation QueryProcessedTraceWith(MATraceLocation[] locations, MACoordinateType type, MAProcessingCallback processingCallback, MAFinishCallback finishCallback, MAFailedCallback failedCallback);
	...
	interface MAHeatMapVectorGridOverlayRenderer
	{
		...
		[Export("initWithHeatOverlay:")]
		IntPtr Constructor(MAHeatMapVectorGridOverlay heatOverlay);
	}
